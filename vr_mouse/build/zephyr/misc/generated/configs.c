...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DIS_PNP_PID, 0xEEEE);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HIDS_SECURITY_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DIRECTED_ADVERTISING, 1);
